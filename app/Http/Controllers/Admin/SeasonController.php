...
class SeasonController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()
            ...
            ->with('success', __('The season :season has been added.', [ 'season' => $season->name ]));
    }
    ...
    public function update(Request $request, Season $season)
    {
        ...
        return redirect()
            ->route('admin.season.index')
            ->with('success', __('The season :season has been edited.', [ 'season' => $season->name ]));
    }
